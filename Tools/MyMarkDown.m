...
InputCell2SE[cellExpression_, width_: 80, length_: 2000] := Module[{str, strFinal}, 
...
debug1=cellExpressionNew;

str=stringReplaceRepeated[StringCases[
debug2=ExportString[cellExpressionNew, "Tex", "BoxRules"->{SubscriptBox[x,y]:>x<>"_"<>y}, 
